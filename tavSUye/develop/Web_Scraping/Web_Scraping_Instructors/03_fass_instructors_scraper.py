...
base_url_en = "https://fass.sabanciuniv.edu/en/faculty-members"
base_url_tr = "https://fass.sabanciuniv.edu/tr/ogretim-uyeleri"
domain = "https://fass.sabanciuniv.edu"
...
def extract_instructor_links():
    ...
    for card in cards:
        ...
        link_tr = link_en.replace("/en/", "/tr/").replace("faculty-members", "ogretim-uyeleri")
...
def main():
    ...
    print("💾 [3/3] Saving results to fass_instructors.json...")
    with open("fass_instructors.json", "w", encoding="utf-8") as f:
        json.dump(instructors, f, indent=2, ensure_ascii=False)

    print(f"\n✅ SUCCESS: Saved {len(instructors)} instructors to fass_instructors.json.")
