...
program_code = "BAVACD"
program_name_en = "Visual Arts and Visual Communications Design"
...
def get_main_page_data(term):
    ...
    result += get_section_courses("Core Electives I", "CORE I")
    result += get_section_courses("Core Electives II", "CORE II")
    return result
...
# JSON çıktısı
with open("bavacd_courses_201701_202502.json", "w", encoding="utf-8") as f:
    json.dump(all_courses, f, indent=2, ensure_ascii=False)

print(f"\n✅ BAVACD programı için toplam {len(all_courses)} ders çekildi.")
