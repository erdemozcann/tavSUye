...
program_code = "BSME"
program_name_en = "Mechatronics Engineering"
...
# JSON çıktısı
with open("bsme_courses_201701_202502.json", "w", encoding="utf-8") as f:
    json.dump(all_courses, f, indent=2, ensure_ascii=False)

print(f"\n✅ BSME programı için toplam {len(all_courses)} ders çekildi.")
