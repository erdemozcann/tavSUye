...
program_code = "BSMAT"
program_name_en = "Materials Science and Nano Engineering"
...
# JSON çıktısı
with open("bsmat_courses_201701_202502.json", "w", encoding="utf-8") as f:
    json.dump(all_courses, f, indent=2, ensure_ascii=False)

print(f"\n✅ BSMAT programı için toplam {len(all_courses)} ders çekildi.")
