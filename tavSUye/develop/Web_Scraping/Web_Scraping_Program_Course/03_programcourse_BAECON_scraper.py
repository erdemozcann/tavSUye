...
def get_main_page_data(term):
    ...
    result += get_section_courses("Mathematics Requirement Courses", "MATH")
    return result
...
for term in terms:
    ...
    # 🔢 Ders sayısını gruba göre yazdır
    count_by_group = {}
...
# 🔽 Sadece kurs listesi JSON’a yazılır
with open("baecon_courses_201701_202502.json", "w", encoding="utf-8") as f:
    json.dump(all_courses, f, indent=2, ensure_ascii=False)

print(f"\n✅ BAECON programı için toplam {len(all_courses)} ders çekildi.")
