...
program_code = "BSEE"
program_name_en = "Electronics Engineering"
...
# JSON çıktısı
with open("bsee_courses_201701_202502.json", "w", encoding="utf-8") as f:
    json.dump(all_courses, f, indent=2, ensure_ascii=False)

print(f"\n✅ BSEE programı için toplam {len(all_courses)} ders çekildi.")
