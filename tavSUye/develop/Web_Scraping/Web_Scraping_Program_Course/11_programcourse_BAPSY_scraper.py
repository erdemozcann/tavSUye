...
def get_main_page_data(term):
    ...
    result += get_section_courses("Philosophy Requirement Course", "PHIL")
    return result
...
# JSON çıktısı
with open("bapsy_courses_201701_202502.json", "w", encoding="utf-8") as f:
    json.dump(all_courses, f, indent=2, ensure_ascii=False)

print(f"\n✅ BAPSY programı için toplam {len(all_courses)} ders çekildi.")
