...
import com.tavsuye.backend.service.CourseCommentRatingService;
...
@RestController
@RequestMapping("/api/course-comment-ratings")
public class CourseCommentRatingController {

    private final CourseCommentRatingService ratingService;

    public CourseCommentRatingController(CourseCommentRatingService ratingService) {
